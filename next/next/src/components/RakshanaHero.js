...
export default function RakshanaHero() {
  ...
  const [content, setContent] = useState({
    title: "Rakshana Television",
    subtitle: "Your Channel for Divine Truth",
  ...
  // Update content when heroData is loaded
  useEffect(() => {
    if (heroData) {
      setContent({
        title: heroData.Title || "Rakshana Television",
        subtitle: heroData.SubTitle || "Your Channel for Divine Truth",
        backgroundImage: heroData.UploadURL || "/hero-bg.jpg"
      });
    }
  }, [heroData]);
