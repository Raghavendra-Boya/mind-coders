  ...
  return (
    <footer className="bg-white text-gray-700 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        {/* Company 1 */}
        <div className="ml-20">
          <h3 className="w-[92px] h-[30px] font-['Fustat'] font-bold text-[20px] leading-[30px] tracking-[0%] opacity-100 mb-4">
            Company
          </h3>
          <ul
       ...
       {/* Company 2 */}
<div className="ml-2"> 
  <h3 className="w-[91px] h-[30px] font-['Fustat'] font-bold text-[20px] leading-[30px] tracking-[0%] opacity-100 mb-4">
    Company
  </h3>
 <ul 
...
>
  ...
  <li><a href="#" className="hover:text-gray-900 block">Donate</a></li>
        ...
        {/* Contact */}
        <div>
          <h3 className="w-[118px] h-[30px] font-['Fustat'] font-bold text-[20px] leading-[30px] tracking-[0%] opacity-100 mb-4">
            Get in Touch
          </h3>
